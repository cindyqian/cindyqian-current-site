    ...
    <div className="All">
      ...
      <div className="About" >
        <div className="profile-container">
          <Rect width="20" height="36" top="10" right="5" /*backgroundImage="linear-gradient(to bottom right, #A5678E, #E8B7D4)"*/color="EB9187"/>
        ...
        <div className="intro-container">
          <Rect width="25" height="91" left="0" top="0" /*backgroundImage="linear-gradient(to bottom right, #F3A9C3, #FBD489)"*/color="EB9187"/>
          <Rect width="25" height="91" left="3" top="5" /*backgroundImage="linear-gradient(to top left, #F3A9C3, #FBD489)"*/color="CB8D9A"/>
